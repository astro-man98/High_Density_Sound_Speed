...
MEV_CGS       = 1e6 * EV_CGS
KB_CGS        = 1.380658e-16          # Bolzmann constant [erg/K]
UAMU_CGS      = UAMU_MEV * MEV_CGS / (C_CGS**2)
RAD_CGS       = 7.5646e-15            # Radiation constant

# The following constants are all given in SI units
FM_SI         = 1.0e-15               # Fentometer
...
MEV_SI        = 1e6 * EV_SI
UAMU_SI       = UAMU_MEV * MEV_SI / (C_SI**2)   # Unified atomic mass unit
